...
LANGUAGES = {
    "PT": {
        ...
        "rec_low_price": "Preço baixo — aproveita para antecipar consumos flexíveis.",
        "rec_high_price": "Preço elevado — privilegia a produção solar disponível e evita comprar energia da rede.",
        "rec_high_solar": "Produção solar elevada — prioriza consumos diretos durante as horas de produção.",
        "rec_partial_solar": "Produção solar ativa mas insuficiente — ajusta consumos para maximizar o autoconsumo.",
        "rec_clouds": "Nebulosidade elevada — espera menor produção solar nas próximas horas.",
    ...
    "EN": {
        ...
        "rec_low_price": "Low price — a good time to shift flexible loads.",
        "rec_high_price": "High price — prioritize available solar and avoid grid consumption.",
        "rec_high_solar": "High solar production — prioritize direct self-consumption while solar is available.",
        "rec_partial_solar": "Solar production is active but insufficient — shift usage to maximize self-consumption.",
        "rec_clouds": "High cloud coverage — solar output is likely to drop in the next hours.",
